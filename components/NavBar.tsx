...
const NavBar = () => {
    return (
      <>
        <nav
            className='fixed p-3 w-[90%] max-w-6xl rounded-3xl top-5 max-sm:top-3 z-50 border dark:border-[#333] flex justify-between dark:text-[#eee] bg-white dark:bg-black'
        >
