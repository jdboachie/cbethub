...
const Tag = ({tag}: {tag?:string}) => {
  return (
    <div
        className='bg-transparent border dark:border-[#333] text-starcommandblue-100 dark:text-lightcyan-100 rounded-full w-fit py-0.5 px-2 text-xs max-sm:text-[0.6rem]
