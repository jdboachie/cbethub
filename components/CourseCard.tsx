...
const CourseCard = () => {
  return (
    <div
        className='border dark:border-[#333] rounded-lg w-[16em] h-[50vh] max-sm:w-[13em] max-sm:h-[40vh] p-5 justify-end items-start flex flex-col space-y-2 m-1.5 cursor-pointer
