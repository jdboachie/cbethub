...
const CourseCard = (
  ...
  return (
    <div
        className='border dark:border-[#333] rounded-lg w-fit h-[50vh] max-sm:h-[40vh] p-5 justify-end items-start flex flex-col space-y-2 m-1.5 cursor-pointer
    ...
    >
        <p
            className='text-left text-sm max-sm:text-sm font-semibold dark:text-[#eee]'
        >
            {courseName}
        </p>
        <p
