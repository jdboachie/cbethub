...
const CourseCardSkeleton = ({grid}: {grid?: boolean}) => {
  return (
    <div className={`border rounded-3xl dark:border-[#333] w-full ${grid && ''} h-fit p-3 justify-end items-start flex flex-col space-y-2 cursor-pointer bg-white dark:bg-black animate-pulse`}>
      ...
      <div className="bg-gray-200 dark:bg-gray-800 rounded-xl h-12 w-80 animate-pulse" />
