...
const CourseCardSkeleton = ({grid}: {grid?: boolean}) => {
  return (
    <div className={`border rounded-xl dark:border-[#333] max-sm:m-0 m-1 h-fit p-3 justify-end items-start flex flex-col space-y-2 cursor-pointer bg-white dark:bg-black animate-pulse`}>
      <div className="bg-gray-200 dark:bg-gray-800 rounded-3xl h-4 w-20 animate-pulse" />
      <div className="bg-gray-200 dark:bg-gray-800 rounded-3xl h-4 w-36 animate-pulse" />
      <div className="bg-gray-200 dark:bg-gray-800 rounded-xl h-6 w-52 animate-pulse" />
