...
const CourseCardSkeleton = () => {
  return (
    <div className="border rounded-lg dark:border-[#333] w-full h-fit p-3 justify-end items-start flex flex-col space-y-2 cursor-pointer bg-white dark:bg-[#111] animate-pulse">
