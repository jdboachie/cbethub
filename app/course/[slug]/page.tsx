        ...
        >
            ...
            >
                ...
                <ul className='flex flex-col space-y-1 rounded-lg text-xs dark:text-[#eee]'>
                    <li className='p-3 flex text-xs font-mono justify-between rounded-lg border dark:border-[#333] bg-gradient-to-b from-blue-50 dark:from-[#020229] via-teal-50 dark:via-[#111] to-white dark:to-[#000] bg-fixed bg-no-repeat bg-cover hover:text-blue-500 dark:hover:text-blue-500 cursor-pointer'>
                        <div className="flex">
